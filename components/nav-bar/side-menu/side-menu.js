...
const SideMenu = () => {
  return (
    <div
      className="catagories-side-menu"
      style={{
        display: "none",
      }}
    >
      ...
      <div className="nav-side-menu">
        <div className="menu-list">
          ...
          <ul id="menu-content" className="menu-content collapse out">
            ...
            >
              <a href="#">
                Woman wear <span className="arrow" />
              </a>
            ...
            >
              <a href="#">
                Bags &amp; Purses <span className="arrow" />
              </a>
